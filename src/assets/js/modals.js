...
const cookies_modal_close_area = cookies_modal.querySelector(
  ".cookies-modal-close-area"
);
const cookies_modal_close = cookies_modal.querySelector(".cookies-modal-close");
const cookies_modal_agree_button = cookies_modal.querySelector(
  ".cookies-modal-agree-button"
);

const openTimeoutMs = 5000; // 5000ms = 5s

const isAllowedCookies = localStorage.getItem("isAllowedCookies") === "true";
